...
const ItemDetailes = ({route,navigation}) => {
  ...
  return (
    <View style={[styles.cantainer, {backgroundColor: themeStyles[theme].backgroundColor}]}>
        ...
        <ScrollView style={[styles.mainview,{backgroundColor: themeStyles[theme].backgroundColorbox}]}>
      ...
      <TouchableOpacity  onPress={() => navigation.navigate('AddItem',{detailsdata,foodPrice,foodname})} style={styles.buttonviewc}>
